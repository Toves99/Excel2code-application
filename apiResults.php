...
<head>
  ...
  <link href="assets/css/apiresults.css" rel="stylesheet">
...
<body>
  ...
  <div class="dire">
    ...
    <div class="view">
        ...
        <p class="p11">Service Family:</p>
        <p class="p12">Individual Service:</p>
        <p class="p13">Calculator Id:</p>
        <p class="p14">Total Calculators:</p>
        <p class="p15">Utilized Calculators:</p>
        <p class="p16">Unutilized Calculators:</p>
        <p class="p17">Date of Order:</p>
        <p class="p18">Expiry period:</p>
        <p class="p19">Total cost paid:</p>
        <p class="p20">Payment status:</p>
