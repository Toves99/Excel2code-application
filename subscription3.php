...
<head>
  ...
  <link href="assets/css/subscribeplan5.css" rel="stylesheet">
...
?>
  <section id="hero" class="d-flex align-items-center">
    <div class="bigdiv">
     ...
     <p>Order your subcription plan now and enjoy our services</p>
    ...
    <table>
      ...
      <?php
        ...
        if($num>0){
          ...
          $unitprice0=$row['unitprice'];
          $benefit=$row['benefit'];
          $maxcal=$row['maxcalculator'];
        }
        ?>
       <tr>
        <td><?php echo $packagename1   ?></td>
        <td>1</td>
        <td><?php echo $benefit  ?></td>
        <td><?php echo $unitprice0  ?></td>
        <td>12 month</td>
        <td><button class="orderNow" id="orderNow">Order Now</button></td>
       </tr>
      ...
      <!---------------------------standard---------------------------------------->
       ...
       <?php
        ...
        ?>
       <tr>
       <td><?php echo $packagename2   ?></td>
        <td>2-5</td>
        <td><?php echo $benefit  ?></td>
        <td><?php echo $unitprice  ?></td>
        <td>12 month</td>
        <td><button class="orderNow"  id="orderNow1">Order Now</button></td>
       </tr>
      ...
      <!-------------------------------gold--------------------------------->
       <?php
        ...
        ?>
       <tr>
       <td><?php echo $packagename3   ?></td>
        <td>6-10</td>
        <td><?php echo $benefit  ?></td>
        <td><?php echo $unitprice1  ?></td>
        <td>12 month</td>
        <td><button class="orderNow"  id="orderNow2">Order Now</button></td>
       </tr>
      ...
      <!-------------------------------------------platinum-------------------->
       <?php
        ...
        ?>
       <tr>
       <td><?php echo $packagename4   ?></td>
        <td>10 & Above</td>
        <td><?php echo $benefit  ?></td>
        <td><?php echo $unitprice2  ?></td>
        <td>12 month</td>
        <td><button class="orderNow" id="orderNow3">Order Now</button></td>
       </tr>
