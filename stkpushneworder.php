...
if (isset($_POST['submit'])) {
  ...
  # Callback URL
  $CallBackURL = 'https://57e3-102-220-12-50.ngrok-free.app/webservices1/callback_url.php';
  ...
  if ($response_array['ResponseCode'] == '0') {
   ...
   <script>
        ...
        setTimeout(function(){
            ...
            window.location.href = 'verifyPaymentneworder.php';
        }, 7000); // Hide the div after 7 seconds and redirect to 'verifyPaymentneworder.php'
