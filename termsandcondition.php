...
<head>
  ...
  <link href="assets/css/terms1.css" rel="stylesheet">
...
<body>
      ...
      <nav id="navbar" class="navbar">
        ...
        <i class="bi bi-list mobile-nav-toggle"></i>
          ...
          <div id="accountDiv" style="position:absolute;width:210px;height:120px;background-color:white;margin-left:1010px;margin-top:180px;display:none;box-shadow:0 0 28px rgba(0,0,0,0.15);border-bottom-right-radius:5px;border-bottom-left-radius:5px;">
             ...
             <a href="updateprofile.php?direction=terms" style="position:absolute;margin-top:35px;margin-left:20px;font-size:15px;color:black;">Update Profile.</a>
  ...
  <section id="about" class="about">
    ...
    <p>
    By accessing and using this website, you acknowledge that you have read, understood, and accepted these Terms of Service, as well as our Privacy Policy
    </p>
    
    <h3 class="h3">2.Intellectual property</h3>
    <p class="p">
    All the content on this website, including but not limited to text, graphics, logos, images, videos, and software, is our property  and is protected by applicable copyright and intellectual property laws. Unauthorized use or reproduction of this content is strictly prohibited.
    </p>


    <h3 class="h4">3.User conduct</h3>
    <p  class="p2">
  ...
  <h3 class="h41">4.User accounts</h3>
    <p  class="p21">
    To access certain features of this website, you may be required to create a user account. You are responsible for maintaining the confidentiality of your account information and for all activities that occur under your account. This involves setting a more strong password and not sharing it with anyone, log out when its not in use and use reliable device to access your account. Should you experience any security related issues with your account, you are advised to report immediately to the relevant authorities within Excel2code IT support team.
  </p>

   
    
  <h3 class="h42">5.Data privacy policy</h3>
    <p  class="p22">
    We take seriously matters to do with people's personal information and we have layed out guidelines on data privacy and data protection. Please review our Privacy Policy, which explains how we collect, use, and protect your personal information. data privacy policy
  </p>

  <h3 class="h43">6.Disclaimer of liabilities</h3>
    <p  class="p23">
    The contents of this website are owned by Us and to this we work hard to ensure that the information on this website is accurate and up-to-date. Excel2code is only liable to contents lawfully related/owned by us and this website.
  </p>


  <h3 class="h44">7.Changes to terms of service</h3>
    <p  class="p24">
    Excel2code reserves the right to modify these Terms of Service at any time without prior notice. Please review the terms regularly to stay informed of any updates.
  </p>


  <h3 class="h45">8.Termination of access</h3>
    <p  class="p25">
    Excel2code may suspend, restrict or terminate access to the website for users who violate these Terms of Service or engage in any improper conduct that is contrary to the governing policies, guidelines, laws and regulations at  Excel2code, National or even International regulations
  </p>

  <h3 class="h46">9.Governing law</h3>
    <p  class="p26">
  ...
  <h3 class="h47">10.Contact us</h3>
    <p  class="p27">
    If you have any questions or concerns regarding these Terms of Service or this website, please contact us at <span style="color:blue">info@exce2code.com or +254715744358</span>.
  </p>
