	...
	*/
    ...
    if($fileHttpResponseCode==200){
      ...
      $insert_query = "INSERT INTO `excelcalculatortb` (`productName`,`monthvalue`,`costperunit`,`totalCost`,`userId`,`productid`,`expiryDate`,`productCategory`,`uploadfile`,`orderid`,`companyid`,`nature`)
			VALUES ('$productName','$monthValue', '$costPerUnit','$totalCost','$user_id','$product_id','$newUploadedTime','$productCategory','$fileupload','$orderid','$companyid','ordered')";
      $query_run = mysqli_query($conn, $insert_query);
      if($query_run){
       //move_uploaded_file($file_temp,$directoryFolder.$file);
        echo "
                ...
                <p style='position:absolute;margin-top:70px;color:white;font-size:18px;margin-left:100px'>Uploading your Excel please wait....</p>
                 ...
                 <script>
                      ...
                      setTimeout(function(){
                          ...
                          window.location.href = 'excelCalculator.php';
                      }, 5000); // Hide the div after 7 seconds and redirect to 'excelCalculator.php'
