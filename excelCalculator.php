...
<head>
  ...
  <link href="assets/css/reviewexcel1.css" rel="stylesheet">
...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <?php
          ...
          <div id="accountDiv" style="position:absolute;width:210px;height:120px;background-color:white;margin-left:1010px;margin-top:180px;display:none;box-shadow:0 0 28px rgba(0,0,0,0.15);border-bottom-right-radius:5px;border-bottom-left-radius:5px;">
             ...
             <a href="updateprofile.php?direction=excelcalculator" style="position:absolute;margin-top:35px;margin-left:20px;font-size:15px;color:black;">Update Profile.</a>
  ...
  <section id="hero" class="d-flex align-items-center">
   ...
   <p style="position:absolute;margin-top:2px;margin-left:100px;color:black;font-weight:bold;">OrderID:<span style="margin-left:5px;color:maroon;font-size:18px;"><?php echo $orderid;  ?></span></p>
   <p style="position:absolute;margin-top:2px;margin-left:260px;color:black;font-weight:bold;">Product:<span style="margin-left:5px;color:maroon;font-size:18px;"><?php echo $productid;  ?></span></p>
   <p style="position:absolute;margin-top:2px;margin-left:480px;color:black;font-weight:bold;">Package:<span style="margin-left:5px;color:maroon;font-size:18px;"><?php echo $packagename;  ?></span></p>
   <p style="position:absolute;margin-top:2px;margin-left:660px;color:black;font-weight:bold;">Expiry Date:<span style="margin-left:5px;color:maroon;font-size:18px;"><?php echo $expirydate;  ?></span></p>
	...
	<button type="submit" name="updateexcelvariables" id="updateexcelvariables" class="b1t" onclick="submitExcelVariablesForm()">Save</button>
	</form>
