...
<head>
  ...
  <link href="assets/css/serviceStyle3.css" rel="stylesheet">
  <style>
     .calldiv{
        position: absolute;
        width:800px;
...
<body>
 ...
 <header id="header" class="fixed-top ">
        ...
        <li class="dropdown"><a href="#"><span>Products</span></i></a>
          ...
          <li class="dropdown"><a href="#"><span>Purchase</span></i></a>
            <ul>
              ...
              <li><a href="privacyindex.php">Policies</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown"><a href="#"><span>Support</span></i></a>
            <ul>
            <li id="call"><a href="#"><img src="image/call1.png" alt="" style="height:30px;width:30px;position:absolute;margin-left:100px;margin-top:-3px;">
                Make A call</a></li>
            </ul>
          </li>
          ...
          <a href="https://3933-196-216-86-91.ngrok-free.app/excel2code/login.php">
    ...
    <div class="container-fluid" data-aos="fade-up">
      <div class="row justify-content-center">
        <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Bettter Digital Experience With us</h1>
          <p>Automatically converts any excel calculator to an Application programming Interface (API) - The generated API can be then be integrated into a web platform, a mobile app or a core back office system etc - Examples of 
            calculators include but not limited to insurance quote calculator, loan projection calculator</p>
  ...
  <section class="service">
   ...
   <h3>IDP.Excel.Execalcalculator2API include</h3>
    <div class="container">
        <div class="box">
            <img src="image/ex.png" alt="">
            <a href="login.php?action=buy" class="ref">
            <h2>IDP.Excel.Execalcalculator API</h2>
            </a>
            <a href="#" class="ref1">
            <p>Automatically converts any excel calculator to an Application programming Interface (API) </p>
            </a>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="aboutusindex">About us</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="termsandconditionsindex.php">Terms of service</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="privacyindex.php">Privacy policy</a></li>
            </ul>
          </div>
