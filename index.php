        ...
        <li class="dropdown"><a href="#"><span>Products</span></i></a>
          ...
          <li class="dropdown"><a href="#"><span>Purchase</span></i></a>
            <ul>
              ...
              <li><a href="login.php?action=buy">Pricing Information</a></li>
    ...
    <div class="container-fluid" data-aos="fade-up">
      <div class="row justify-content-center">
        <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <h2>We are an intelligent document processing unit</h2>
          <div><a href="signup.php" class="btn-get-started scrollto">Get Started</a></div>
        </div>
        <div class="col-xl-4 col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="150">
          <img src="image/backimage.png" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
