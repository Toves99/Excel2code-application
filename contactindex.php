...
<head>
  ...
  <link href="assets/css/contactindex.css" rel="stylesheet">
        ...
        <div class="row gy-4">
          <div class="col-lg-6">
            <div class="info-item  d-flex flex-column justify-content-center align-items-center">
              <i class="bi bi-map" style="color:maroon;"></i>
              <h3>Our Address</h3>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="info-item d-flex flex-column justify-content-center align-items-center">
              <i class="bi bi-envelope" style="color:maroon;"></i>
              <h3>Email Us</h3>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="info-item  d-flex flex-column justify-content-center align-items-center">
              <i class="bi bi-telephone" style="color:maroon;"></i>
              <h3>Call Us</h3>
              <p>+254715744358</p>
            </div>
          </div><!-- End Info Item -->
        ...
        <div class="row gy-4 mt-1">
          ...
          <div class="col-lg-6">
            ...
            <form id="myForm" class="php-email-form">
              ...
              <div class="text-center"><button type="submit" onclick="sendEmail()" style="background-color:maroon;">Send Message</button></div>
            </form>
