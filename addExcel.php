...
<head>
  ...
  <link href="assets/css/addExcel4.css" rel="stylesheet">
...
<body>
 ...
 <div class="form">
   <h3>Subscription FAilure</h3>
   <p class="vp">Your payment failed therefore your subscription has been cancelled</p>
     
     <a href="subscription3.php">
    <button>Subscribe Again</button>
    </a>
    
    <a href="dashboard.php">
    <button class="bapi1">Exit</button>
    </a>
</div>
